...
namespace EpicChain.API.v2.StorageGroup {
    ...
    static TypesReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EpicChain.API.v2.StorageGroup.StorageGroup), global::EpicChain.API.v2.StorageGroup.StorageGroup.Parser, new[]{ "ValidationDataSize", "ValidationHash", "ExpirationEpoch", "Members" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class StorageGroup : pb::IMessage<StorageGroup> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::EpicChain.API.v2.StorageGroup.TypesReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::EpicChain.API.v2.Refs.Checksum validationHash_;
    /// <summary>
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::EpicChain.API.v2.Refs.Checksum ValidationHash {
    ...
    private static readonly pb::FieldCodec<global::EpicChain.API.v2.Refs.ObjectID> _repeated_members_codec
        = pb::FieldCodec.ForMessage(34, global::EpicChain.API.v2.Refs.ObjectID.Parser);
    private readonly pbc::RepeatedField<global::EpicChain.API.v2.Refs.ObjectID> members_ = new pbc::RepeatedField<global::EpicChain.API.v2.Refs.ObjectID>();
    /// <summary>
    /// Strictly ordered list of storage group member objects
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::EpicChain.API.v2.Refs.ObjectID> Members {
      get { return members_; }
    }
    ...
    public void MergeFrom(StorageGroup other) {
      ...
      if (other.validationHash_ != null) {
        if (validationHash_ == null) {
          ValidationHash = new global::EpicChain.API.v2.Refs.Checksum();
        }
